...
![Version](https://img.shields.io/badge/version-2.1.5-green) [![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)
...
app.component("ResizeBounding", ResizeBounding);
app.mount("#app");
```
