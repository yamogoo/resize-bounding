![image](https://raw.githubusercontent.com/yamogoo/vue3-resize-bounding/v2.0.6/shared/images/resize-bounding-w-descriptor.svg)
![Version](https://img.shields.io/badge/version-2.0.6-green) [![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)
...
![image](https://raw.githubusercontent.com/yamogoo/resize-bounding/v2.0.6/shared/images/resize-bounding.gif)

Interactive Grid (Example):

- [stackblitz](https://stackblitz.com/edit/vue3-resize-bounding-example?file=src%2FApp.vue)
- [github](https://github.com/yamogoo/resize-bounding/blob/v2.0.6/packages/vue/playground/vite-app/src/components/InteractiveGrid.vue)
