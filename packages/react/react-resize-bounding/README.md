![image](https://raw.githubusercontent.com/yamogoo/resize-bounding/v2.0.8/shared/images/resize-bounding-w-descriptor.svg)
![Version](https://img.shields.io/badge/version-1.0.7-blue) [![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://opensource.org/licenses/MIT)
...
![image](https://raw.githubusercontent.com/yamogoo/resize-bounding/v2.0.8/shared/images/resize-bounding.gif)

Interactive Grid (Example):

- [stackblitz](https://stackblitz.com/edit/react-resize-bounding-example?file=src%2FApp.tsx)
- [github](https://github.com/yamogoo/resize-bounding/blob/v2.0.8/packages/react/playground/vite-app/src/components/InteractiveGrid.tsx)
